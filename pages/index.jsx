...
const Home = () => {
  return (
    <div className=" flex h-full min-h-screen w-full flex-col overflow-hidden bg-brand-light">
      ...
      <header className="min-w-full py-14 px-4 text-gray-800 md:px-0">
        <div className="container mx-auto flex h-full max-w-5xl items-center justify-between">
          {/* Logo */}
          <Link href="#">
            <a className="font-coiny text-xl font-bold md:text-3xl">
              <span className="bg-gradient-to-br from-brand-blue to-brand-purple bg-clip-text pr-2 text-transparent">
                Bored
              </span>
              Ape
            </a>
        ...
        <div className="flex w-full max-w-4xl flex-col items-center">
          <Link href="/mint" passHref>
            <a className="oy-2 mt-16 inline-flex items-center rounded px-6 text-center font-coiny text-sm font-medium uppercase text-rose-500 hover:bg-rose-600 hover:text-white sm:text-2xl md:text-3xl">
              Go to minting page
              <img
                className="ml-2 mt-0.5 h-6 w-6 stroke-2"
          ...
          <div className="mt-20 flex w-full flex-col items-center space-y-10 md:flex-row md:space-x-16">
            {/* BoredApe Image */}
            <img
              src="/images/aboutBoredApe.png"
              className="w-42 h-64 rounded-md object-cover"
            />

            <div className="mt-14 flex flex-col items-center justify-center px-4 py-10 font-coiny  text-gray-800 md:items-start md:px-0">
